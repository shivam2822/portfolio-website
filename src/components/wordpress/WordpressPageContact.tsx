        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <motion.button
                type="submit"
                className="w-full bg-green-600 text-white py-3 px-6 rounded-lg font-medium flex items-center justify-center space-x-2 hover:bg-green-700 transition-colors disabled:bg-green-400 disabled:cursor-not-allowed"
...
export default WordpressPageContact;
